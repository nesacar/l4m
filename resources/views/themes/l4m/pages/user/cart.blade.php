            ...
            <form action="{{ route('cart.update') }}" method="POST" id="cart-update">
              ...
              <section class="container cart_header">
                ...
                <div class="cart_header-line cart_secondary-text">
                  <div>Imate {{ \Cart::count() }} {{ \Cart::count()%10 == 1 ? 'proizvod' : 'proizvoda'  }} u korpi.
                  </div>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-8">
                    ...
                    <div class="cart_actions">
                      ...
                      <a class="btn btn--primary btn--block" id="submit" href="{{ url('placanje/adresa-slanja') }}">Idite na plaćanje</a>
                    </div>
                  </div>
                </div>
              </section>
